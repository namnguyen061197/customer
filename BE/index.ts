...
app.get('/api/customers', (req: Request, res: Response) => {
    ...
    if(search){
        const filterCustomer = customers.filter(cus => (cus.firstName.toLowerCase()+cus.lastName.toLowerCase()).includes(search.toString()))
        res.json(filterCustomer);
        return;
    }
    res.json(customers);
});
...
app.get('/api/customers/:id', (req: Request, res: Response) => {
    ...
    selectedCustomer = customers.find(cus => cus.id === customerId);
    if(selectedCustomer){
